...
public class JMusicBot {
    ...
    public static final String PROJECT_FORK_USERNAME = "Timboy67678";
    public static final String PROJECT_FORK_REPO = "MusicBot";
    public static final String PROJECT_URL = "https://github.com/" + PROJECT_FORK_USERNAME + "/" + PROJECT_FORK_REPO;
        ...
        try {
            JDA jda = JDABuilder.create(config.getToken(), Arrays.asList(INTENTS))
                    ...
                    .setAudioModuleConfig(new net.dv8tion.jda.api.audio.AudioModuleConfig()
                            .withDaveSessionFactory(new moe.kyokobot.libdave.jda.LDJDADaveSessionFactory(
                                    new moe.kyokobot.libdave.NativeDaveFactory())))
                    .build();
            bot.setJDA(jda);
    ...
    private static CommandClient createCommandClient(BotConfig config, SettingsManager settings, Bot bot) {
        ...
        AboutCommand aboutCommand = new AboutCommand(Color.BLUE.brighter(),
                "a music bot that is [easy to host yourself!](" + JMusicBot.PROJECT_URL + ") (v" + JMusicBot.VERSION
                        + ")",
