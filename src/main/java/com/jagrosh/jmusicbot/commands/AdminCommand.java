...
public abstract class AdminCommand extends SlashCommand
{
    ...
    /**
     * Checks whether the slash command invoker has admin-level access:
     * bot owner OR Manage Server permission.
     */
    protected static boolean checkAdminPermission(SlashCommandEvent event)
    {
